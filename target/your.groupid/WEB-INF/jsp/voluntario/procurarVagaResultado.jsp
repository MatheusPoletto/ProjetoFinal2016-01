			...
			<nav class="navbar navbar-default navbar-fixed">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">Resultado da busca</a>
					</div>
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-md-12">
										<div class="card">
											<div class="header">
												<h4 class="title">Resultado da Busca</h4>
												<p class="category">Aqui estão as vagas que correspondem
													a sua busca.</p>
											</div>
											<div class="content table-responsive table-full-width">
												<table class="table table-hover table-striped">
													...
													<tbody>
														<c:forEach items="${vagasPesquisa}" var="vaga">
															<tr>
																<td>${vaga.codigo}</td>
																<td>${vaga.nomeVaga}</td>
