					...
					<div class="row">
						<div class="col-sm-12 col-sm-offset-1 col-md-10 main">
							...
							<form class="form-horizontal"
								action="<c:url value='/salvarVaga'/>" method="post">
								<div class="form-group">
									<label class="col-sm-2">Nome <br> da Vaga
									</label>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="vaga.nomeVaga"
											value="${vaga.nomeVaga}" placeholder="Nome da Vaga" required/>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="number" class="form-control"
											name="vaga.quantidadeVaga" value="${vaga.quantidadeVaga}"
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-9">
										...
										</select> <input type="hidden" id="vaga.importancia"
											name="vaga.importancia" value="${vaga.importancia}" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										</select> <input type="hidden" id="vaga.presencial"
								...
								<div class="form-group form-inline">
									...
									<div class="col-sm-9">
										<fieldset>
												...
												name="vaga.estado" id="vaga.estado" value="${vaga.estado}" />
												<select id="cidade" name="cidade" class="col-xs-12 col-sm-6"
												onchange="trocaCidade()"></select> <input type="hidden"
												name="vaga.cidade" id="vaga.cidade" value="${vaga.cidade}" />
										</fieldset>
									</div>
        ...
        new dgCidadesEstados(
            ...
            true
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<textarea name="vaga.descricao" value="${vaga.descricao}"
